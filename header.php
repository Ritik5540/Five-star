        ...
        <header class="header_area">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="navbar-brand logo_h" href="index.php"><img src="img/logo.jpg" alt="logo" style="logo"></a>
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="contact.php">Harmu Housing Colony, Ranchi</a></li>
                                    <li class="nav-item"><a class="nav-link" href="lalpur_contact.php">Lalpur, Ranchi</a></li>
                                </ul>
                            </li> 
                        </ul>
                    </div> 
